...
funcao relatorio(){
	...
	escreva("Novos livros cadastrados:",somar[0]+somar[1]+somar[2]+somar[3]+somar[4]+somar[5]+somar[6]+somar[7]+somar[8]+somar[9])
 ...
 * 
 * @POSICAO-CURSOR = 90687; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {cadastro_gestao, 122, 15, 15}-{somar, 132, 12, 5};
